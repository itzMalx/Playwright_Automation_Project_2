...
Feature:  Muhindhar_12-08-2026(updated)_Delete a trainee training record
    ...
    Scenario Outline: Verify trainee training record is available before deletion
        Given user is on the homepage of the employee training records
        When user searches for the trainee with employee ID "<empId>"
        Then the trainee with employee ID "<empId>" should be displayed in the list
